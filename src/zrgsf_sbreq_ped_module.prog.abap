...
* Monta o catálogo de campos, definindo nome e tamanho *
    ...
    ls_fieldcat-coltext   = 'Pedido'.
    ls_fieldcat-outputlen = 10.
    APPEND ls_fieldcat TO lt_fieldcat.

    FREE ls_fieldcat.
    ls_fieldcat-fieldname = 'EBELP'.
    ls_fieldcat-coltext   = 'Item Pedido'.
    ls_fieldcat-outputlen = 15.
    APPEND ls_fieldcat TO lt_fieldcat.

    FREE ls_fieldcat.
    ls_fieldcat-fieldname = 'AEDAT'.
    ls_fieldcat-coltext   = 'Data Pedido'.
    ls_fieldcat-outputlen = 15.
    APPEND ls_fieldcat TO lt_fieldcat.
    ...
    FREE ls_fieldcat.
    ls_fieldcat-fieldname = 'REVIS'.
    ls_fieldcat-coltext   = 'Revisado'.
    ls_fieldcat-outputlen = 10.
    APPEND ls_fieldcat TO lt_fieldcat.
    ...
    FREE ls_fieldcat.
    ls_fieldcat-fieldname = 'FORNE'.
    ls_fieldcat-coltext   = 'Fornecedor'.
    ls_fieldcat-outputlen = 10.
    APPEND ls_fieldcat TO lt_fieldcat.

    FREE ls_fieldcat.
    ls_fieldcat-fieldname = 'DESC_FORNE'.
    ls_fieldcat-coltext   = 'Descrição Fornecedor'.
    ...
    ls_fieldcat-coltext   = 'Preço Líquido'.
    ls_fieldcat-outputlen = 15.
    APPEND ls_fieldcat TO lt_fieldcat.
